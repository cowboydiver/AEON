...
describe('oxygen: bounds, ablation and the Great Oxidation (#37)', () => {
  ...
  it('is a monotone driver: doubling marine productivity raises the next O₂', () => {
    ...
    // the legacy (V2 + datum trio off) substrate: this is an OXYGEN-system
    // property test, and the #115/#127-item-9 promotions' shifted tectonic/climate
    // substrate otherwise move the abiogenesis window so no marine life exists at
    // step 60 (both arms zero).
