...
function probeKeyframe(timeYears: number, events: SimEvent[] = []): Keyframe {
  ...
  const globals = {
    ...
    columnsThicknessCapBinds: 0, columnsMaturationFlips: 0,
    columnsMaturationElevSumM: 0, columnsMaturationCreditM3: 0,
    columnsRegularizedCreditM3: 0, columnsFounderTrimM3: 0,
    columnsRetiredDebitM3: 0, columnsRetiredCells: 0,
  };
  return { timeYears, fields, globals, events };
}
